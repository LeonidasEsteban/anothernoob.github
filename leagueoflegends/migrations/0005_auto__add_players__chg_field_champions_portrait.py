...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'leagueoflegends_players', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nickname', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'leagueoflegends', ['Players'])


        # Changing field 'Champions.portrait'
        db.alter_column(u'leagueoflegends_champions', 'portrait', self.gf('athumb.fields.ImageWithThumbsField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'Players'
        db.delete_table(u'leagueoflegends_players')


        # Changing field 'Champions.portrait'
        db.alter_column(u'leagueoflegends_champions', 'portrait', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'leagueoflegends.champions': {
            ...
            'portrait': ('athumb.fields.ImageWithThumbsField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
