...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'File'
        db.create_table(u'library_file', (
        ...
        db.send_create_signal(u'library', ['File'])


    def backwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'library_file')
    ...
    models = {
        ...
        u'library.news': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
